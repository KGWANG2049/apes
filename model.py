...
class APESCriticNet(nn.Module):
    def __init__(self, oc, start_v, goal_v, coefficients):
        ...
        self.conv1 = nn.Conv3d(1, 64, kernel_size=(3, 3, 3), stride=2, padding=0)
        self.mp = torch.nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2), padding=(0, 0, 0))
        self.conv2 = nn.Conv3d(64, 64, kernel_size=(3, 3, 3), stride=2, padding=0)
        self.conv3 = nn.Conv3d(64, 64, kernel_size=(3, 3, 3), stride=2, padding=0)
